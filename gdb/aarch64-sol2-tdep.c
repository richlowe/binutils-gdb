...
static CORE_ADDR
aarch64_sol2_mcontext_addr (frame_info_ptr this_frame)
{
...
static struct aarch64_frame_cache *
aarch64_sol2_sigtramp_frame_cache (frame_info_ptr this_frame,
				   void **this_cache)
{
  struct aarch64_frame_cache *cache;
...
static void
aarch64_sol2_sigtramp_frame_this_id (const frame_info_ptr &this_frame,
				     void **this_cache,
...
static struct value *
aarch64_sol2_sigtramp_frame_prev_register (const frame_info_ptr &this_frame,
					   void **this_cache,
					   int regnum)
{
  struct aarch64_frame_cache *cache =
